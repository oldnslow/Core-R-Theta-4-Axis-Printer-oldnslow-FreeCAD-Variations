...
; Updated 2025 04 26 commit c3e7d44

global B_OFFSET = 0
global X_LENGTH = 115.5                                    ; actually 117.0 but this stops some squshing issues
; global X_LENGTH = 117

; General preferences
G90                                                        ; send absolute coordinates...
M83                                                        ; ...but relative extruder moves
M550 P"Core-R-Theta"                                    ; set printer name

; Network
;M552 S1                                                    ; enable network
M552 S0                                                    ; temporarily disable network to facillitate initial firmaware install
...
; Accelerometer
;M955 P0 C"PB_2+PA_10" I46                                 ; disable as not used by Core-R-Theta
